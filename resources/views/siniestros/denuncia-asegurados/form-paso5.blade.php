<form class="container w-75" action='{{route("asegurados-denuncias-paso5.store")}}' method="post">
    @csrf
    ...
    <div class="container form-denuncia-siniestro p-4">
        ...
        <div class="row mt-3">
            ...
            <div class="form-group">
                ...
                <input type="text" id="modelo" name="modelo" class="form-control form-estilo"
        ...
        <div class="col-12 col-md-4">
            <div class="form-group">
                ...
                <input type="text" id="vehiculo_anio" name="vehiculo_anio" class="form-control form-estilo"
        ...
        <div class="col-12 col-md-4">
            <div class="form-group">
                ...
                <input type="text" id="vehiculo_dominio" name="vehiculo_dominio" class="form-control form-estilo"
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="vehiculo_motor" name="vehiculo_motor" class="form-control form-estilo"
                       maxlength="255"
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <input type="text" id="vehiculo_chasis" name="vehiculo_chasis" class="form-control form-estilo"
                       maxlength="255"
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-3">
            <div class="form-check">
                <input type="checkbox"  class="form-check-input" id="vehiculo_siniestro_danio" name="vehiculo_siniestro_danio"
        ...
        <div class="col-12 col-md-3">
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="vehiculo_siniestro_robo" name="vehiculo_siniestro_robo"
        ...
        <div class="col-12 col-md-3 pt-0">
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="vehiculo_siniestro_incendio" name="vehiculo_siniestro_incendio"
