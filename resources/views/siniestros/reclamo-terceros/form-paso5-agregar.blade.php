<form class="" action='{{route("siniestros.terceros.paso5.lesionado.store")}}' method="post">
    @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="tipo_documento_id" id="tipo_documento"
                        ...
                        @foreach($tipo_documentos as $tipo_documento)
                            <option
                                value="{{$tipo_documento->id}}" {{ old('tipo_documento_id') && old('tipo_documento_id') == $tipo_documento->id ? 'selected' : '' }}>{{ $tipo_documento->nombre }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="documento_numero" id="documento_numero" maxlength="8"
                           ...
                           value="{{ old('documento_numero') ? old('documento_numero') : '' }}">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento"
                           ...
                           value="{{ old('fecha_nacimiento') ? old('fecha_nacimiento') : '' }}"
                    >
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="codigo_postal" id="codigo_postal"
                           ...
                           value="{{ old('codigo_postal') ? old('codigo_postal') : '' }}">
