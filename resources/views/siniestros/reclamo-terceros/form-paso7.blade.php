<form class="" action='{{route("siniestros.terceros.paso7.store")}}' method="post">
    ...
    <div class="container mt-3 form-denuncia-siniestro p-4">
            ...
            <table class="table">
                ...
                @foreach($reclamo->testigos as $testigo)
                    <tr style="background-color: rgba(0,0,0,.05);">
                        ...
                        <td class="text-right">
                            <a title="Editar" class="mr-1" href="{{ route('siniestros.terceros.paso7.testigo.edit',['id'=> request('id'),'testigo'=> $testigo->id])}}"><i class="fa-solid fa-pen-to-square text-primary"></i></a>
                            <a title="Borrar" href="{{route('siniestros.terceros.paso7.testigo.delete',['id'=> request('id'),'testigo'=> $testigo->id])}}"><i class="fa-solid fa-trash-can text-danger"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('siniestros.terceros.paso7.testigo.create',['id'=> request('id')])}}"
                   style="color:#6E4697;">
