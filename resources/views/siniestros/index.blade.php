...
<div class="container">
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-8 ">
            <div class="bg-black-siniestro">
                <p class="pt-3 align-self-center text-center que-hacer-siniestro">¿Qué hacer ante un siniestro?</p>
            </div>
        </div>
    ...
    <div class="pt-5 row">
        <div class="col-12 col-md-8 mx-auto text-center">
            <p class="legal-siniestro">El tomador o derechohabiente, comunica al asegurador el acaecimiento del siniestro dentro de los tres dias (Ley 17418/46.1)
                El asegurado esta obligado a suministrar al asegurador, a su pedido, la informacion necesaria para verificar el siniestro y permitir las indagaciones necesarias a tal fin (Ley 17418/46.2)
            </p>
        </div>
