    ...
    <div class="container">
        <div class="row">
            <div class="col-12 pt-5">
                    ...
                    <form action="/panel-siniestros/buscador" method="get">
      ...
      <table class="table" style="min-height:200px;margin-bottom: 120px;">
            ...
            <tbody>
              ...
              <tr class="borde-tabla">
                ...
                <td><input onblur="save('siniestro',{{route('panel-siniestros.denuncia.update.nrosiniestro',$denuncia->id)}})" type="text" id="nsiniestro" name="nsiniestro" value="1" style="height: 21px;width:70px !important;"></td>
                <td>
                  <select name="select">
                ...
                <td>@if($denuncia->state != 12)<span style="color:#FF9400;">{{'Carga en curso - Paso '.$denuncia->state.'/12'}}</span>@else <span style="color:#545358;">COMPLETO</span>@endif</td>
              	<td><a target="_blank" href="https://api.whatsapp.com/send?phone=+54{{$denuncia->precarga_responsable_contacto_telefono}}&text=Inicia tu denuncia ingresando a este link: {{route('asegurados-denuncias-paso1.create',['id' => $denuncia->identificador])}}" style="color:#3366BB; font-weight: bold; " data-toggle="tooltip" data-placement="top" title="Enviar link denuncia"><img src="{{url('/images/siniestros/denuncia_asegurado/backoffice/link_no_enviado.png')}}"></a></td>

                <td>


                  <a href="#" style="color:#3366BB; font-weight: bold; margin-right:8px; " data-toggle="tooltip" data-placement="top" title="Enviar a compañia"><img src="{{url('/images/siniestros/denuncia_asegurado/backoffice/emitir.png')}}"></a>


                  <a href="{{route('panel-siniestros.denuncia.show',$denuncia->id)}}" style="color:#3366BB; font-weight: bold; margin-right:8px; " data-toggle="tooltip" data-placement="top" title="Ver"><img src="{{url('/images/siniestros/denuncia_asegurado/backoffice/ver.png')}}"></a>

                  <a href="#" style="color:#3366BB; font-weight: bold; margin-right:8px; " data-toggle="tooltip" data-placement="top" title="Editar"><img src="{{url('/images/siniestros/denuncia_asegurado/backoffice/editar.png')}}"></a>

                  <a onclick="eliminar('{{route('panel-siniestros.denuncia.delete',$denuncia->id)}}')" href="#" style="color:#3366BB; font-weight: bold; margin-right:8px; " data-toggle="tooltip" data-placement="top" title="Eliminar"><img src="{{url('/images/siniestros/denuncia_asegurado/backoffice/eliminar.png')}}"></a>
  {{--
