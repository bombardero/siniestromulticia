<form class="" action='{{route("asegurados-denuncias-paso3.store")}}' method="post">
    ...
    <div class="container form-denuncia-siniestro p-4">
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    <select name="pais" id="pais" class="custom-select form-estilo">
                        ...
                        <option value="otro" {{ old('pais') && old('pais') == 'otro' ?  'selected' : ($denuncia_siniestro->conductor && $denuncia_siniestro->conductor->pais_id == null ? 'selected' : '') }}>Otro</option>
                    </select>
                </div>
            </div>

            <div class="col-12 col-md-8 {{ (old('pais') && old('pais') == 'otro') || ($denuncia_siniestro->conductor && !$denuncia_siniestro->conductor->pais_id && !$denuncia_siniestro->conductor->province_id && !$denuncia_siniestro->conductor->city_id)  ?  '' : 'd-none' }}" id="div_otro_pais_provincia_localidad">
                <div class="form-group">
            ...
            <div class="col-12 col-md-4 {{ (old('pais') && old('pais') == 'otro') || ($denuncia_siniestro->conductor && $denuncia_siniestro->conductor->province_id == null) ?  'd-none' : '' }}" id="div_provincia">
                <div class="form-group">
            ...
            <div class="col-12 col-md-4 {{ (old('pais') && old('pais') == 'otro') || ($denuncia_siniestro->conductor && !$denuncia_siniestro->conductor->pais_id && !$denuncia_siniestro->conductor->province_id) ?  'd-none' : '' }}" id="div_localidad">
                <div class="form-group">
                    <label for="localidades">Localidad</label>
                    <div class="input-group">
                        <select name="localidad_id" id="localidades" class="custom-select form-estilo {{ old('check_otra_localidad') || ($denuncia_siniestro->conductor && $denuncia_siniestro->conductor->otro_pais_provincia_localidad) ? 'd-none' :  '' }}">
                        ...
                        <input type="text" name="otra_localidad" id="otra_localidad" maxlength="255"
                               class="form-control form-estilo {{ old('check_otra_localidad') || ($denuncia_siniestro->conductor && $denuncia_siniestro->conductor->otro_pais_provincia_localidad) ? '' : 'd-none' }}"
                               value="{{ $denuncia_siniestro->conductor && $denuncia_siniestro->conductor->otro_pais_provincia_localidad != null ? $denuncia_siniestro->conductor->otro_pais_provincia_localidad : '' }}"
                        >
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <input type="checkbox" id="check_otra_localidad" name="check_otra_localidad"
                                       class="mr-1" {{ old('check_otra_localidad') || ($denuncia_siniestro->conductor && $denuncia_siniestro->conductor->otro_pais_provincia_localidad) ? 'checked' :  '' }}>Otra
                            </div>
                        </div>
                    </div>
