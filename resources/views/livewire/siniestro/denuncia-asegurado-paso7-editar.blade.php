    ...
    <form class="w-75 mx-auto container-page" action='{{route("asegurados-denuncias-paso7.update")}}' method="post">
        ...
        <div class="container w-100 pt-3 contenedor-custom"
            ...
            <div class="input-group  margin-bottom-en-ambos margin">
                ...
                <div class="col-12 col-md-12 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="propietario_nombre"
                               placeholder="Nombre y apellido del propietario de las cosas materiales"
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <select class='w-100' name="propietario_documento_id" id="tipo_documentos"
                                style="border-radius:10px; height: 33px;background: white;">
                            @foreach($tipo_documentos as $tipo_documento)
                                <option
                                    value="{{$tipo_documento->id}}" {{ $danio->propietario_tipo_documento_id == $tipo_documento->id ? 'selected' : ''}}>{{$tipo_documento->nombre}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-12 col-md-12 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="propietario_domicilio" placeholder="Domicilio"
                               style="border-radius:10px; height: 33px;background: white;"
