<div>
    ...
    <form class="w-75 mx-auto container-page" action='{{route("asegurados-denuncias-paso10.store")}}' method="POST"
        ...
        <div class="container w-100 pt-3 contenedor-custom"
            ...
            <div class="input-group  ">
                ...
                <div class="pl-2">
                    <label id="rotondaText" class="grafico escenarios"><input class="opacity" type="radio" id="rotonda"
                                                                              name="screen">ROTONDA</label>
                    <label id="rutaText" class="escenarios grafico"><input class="opacity" type="radio" id="ruta"
                                                                           name="screen">RUTA/CALLE</label>
                    <label id="interseccionText" class="escenarios grafico"><input class="opacity" type="radio"
                                                                                   id="interseccion" name="screen">INTERSECCIÓN</label>
                    <label id="otrosText" class="escenarios"><input class="opacity" type="radio" id="otros"
                                                                    name="screen">OTROS</label>
                ...
                <div class="grafico" id="grafico">
                    ...
                    <div style=" " id="cardAutomotor"
                         class="mt-3 w-100 card card-automotor background-card-iconos mx-auto">
                    ...
                    <div class="col-12 pt-5 pt-md-0">
                        <p>
                            <button id="clearBtn" class="btn btn-default">Limpiar</button>
                            &nbsp
                ...
                <div class="pt-3 col-12">
                    <textarea placeholder=" Ampliar descripcion " style="width:100%; border-radius:10px;"
                              name="description" rows="4">@if(isset($denuncia_siniestro->croquis_descripcion))
                            {{$denuncia_siniestro->croquis_descripcion}}
                        @endif</textarea>
                </div>
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="comisaria" placeholder="Comisaria"
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="acta" placeholder="Acta N°"
                               style="border-radius:10px; height: 33px;background: white;"
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="folio" placeholder="Folio"
                               style="border-radius:10px; height: 33px;background: white;"
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="sumario" placeholder="Sumario"
                               style="border-radius:10px; height: 33px;background: white;"
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="juzgado" placeholder="Juzgado"
                               style="border-radius:10px; height: 33px;background: white;"
                ...
                <div class="col-12 col-md-4 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="secretaria" placeholder="Secretaria"
                               style="border-radius:10px; height: 33px;background: white;"
