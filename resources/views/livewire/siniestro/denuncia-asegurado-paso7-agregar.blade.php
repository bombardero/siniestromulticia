<div>
    <form class="w-75 mx-auto container-page" action='{{route("asegurados-denuncias-paso7agregar.store")}}' method="post">
        @csrf
            ...
            <div class="input-group  margin-bottom-en-ambos margin">
                 ...
                 <div class="col-12 col-md-12 pt-3">
                    <div class="input-group  ">
                        ...
                        <textarea class='w-100' type="text" name="danio_detalles" placeholder="*Detalles de los daños a las cosas 1500 caracteres" style="border-radius:10px; height: 82px;background: white;" name="vehiculo_detalles"></textarea>
                    </div>
                </div>
            	...
            	<div class="col-12 col-md-12 pt-3">
                    <div class="input-group  ">
                        <input class='w-100' type="text" name="propietario_nombre" placeholder="Nombre y apellido del propietario de las cosas materiales" style="border-radius:10px; height: 33px;background: white;">
                    </div>
                </div>
