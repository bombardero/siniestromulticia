            ...
            <div class="input-group  margin-bottom-en-ambos margin">
                 ...
                 <div class="col-12 col-md-12 pt-3">
                    <div class="input-group  ">
                        ...
                        <textarea class='w-100' type="text" name="detalles" placeholder="*Detalles de los daños a las cosas 1500 caracteres" style="border-radius:10px; height: 82px;background: white;"></textarea>
                    </div>
                </div>
