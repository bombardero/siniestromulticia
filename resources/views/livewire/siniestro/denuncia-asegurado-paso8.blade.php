        ...
        <div class="container w-100 pt-3 contenedor-custom" style="background-image:url('/images/background_siniestro_stepper.png') !important;background-size: cover; background-repeat: no-repeat;min-height: 400px;border-radius: 30px;padding-left: 48px;padding-top: 32px;">
            ...
            <div class="input-group  ">
                ...
                <div class="col-12 col-md-1">
                    <div class="input-group  ">
                        <input type="checkbox" wire:model.defer="terminos_condiciones" class="form-check-input" id="checkbox_lesionados_si" name="lesionados_si" {{$denuncia_siniestro->carga_paso_8_lesionados_si == 'on' ? 'checked':''}}>
                        <label>Si</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-1">
                    <div class="input-group  ">
                        <input type="checkbox" wire:model.defer="terminos_condiciones" class="form-check-input" id="checkbox_lesionados_no" name="lesionados_no" {{$denuncia_siniestro->carga_paso_8_lesionados_no == 'on' ? 'checked':''}}>
                        <label>No</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="input-group  ">
                        <label style="color: #E51C00;font-size: 12px;"><img src="/images/siniestros/denuncia_asegurado/informacion_rojo.png" style="margin-bottom: 2px;"/>No incluye al conductor del vehículo asegurado</label>
                    </div>
                </div>
                      ...
                      <table class="table" style="margin-bottom: 120px;">
                           <tbody>
                              ...
                              <tr class="borde-tabla">
                                ...
                                <td><a href="{{route('asegurados-denuncias-paso8.edit',['id'=> request('id'),'v'=> $lesionado->id])}}"><img src="{{url('/images/siniestros/denuncia_asegurado/editar.png')}}"></a></td>
                                </div>
                              </tr>
                              @endforeach
                              @else
                ...
                {{-- FIN TABLE*********************************  --}}
                 ...
                 <div class="col-12 col-md-12">
                    <div class="input-group  ">
                        <a href="{{route('asegurados-denuncias-paso8agregar.create',['id'=> request('id')])}}" style="color:#6E4697;"><img src="{{url('/images/siniestros/denuncia_asegurado/agregar.png')}}"/> Agregar ítem de persona lesionada</a>
                    </div>
                </div>
                    ...
                    <span style="color:red;">
                     ...
                     <a class="mt-5 boton-enviar-siniestro btn " style="border:1px solid #6e4697;font-weight: bold;background: transparent;color: #6e4697;" href='{{route('asegurados-denuncias-paso7.create',['id'=> request('id')])}}'>ANTERIOR</a>
