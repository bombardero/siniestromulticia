    ...
    @endif
    	<div class = "bg-form">
		    <p class="pt-5 pb-3 completa-datos text-center">
		      Información Propietario (Persona Juridica)
			</p>
	     	...
	     	<div class="col-12">
		        	   @error('nombre') <span class="pl-2 text-danger">{{ $message }}</span> @enderror
			            <div class="input-group  ">
			            	<input class="mayus form-estilo prueba w-100" type="text" class="form-control" id="name" placeholder="  Razon Social" wire:model.defer="nombre">
			            </div>			
		        	</div>
		        ...
		        <div class="form-group row">
	     			<div class="col-12 col-md-6">
			            ...
			            <div class="input-group  ">
			               <input class="form-estilo prueba w-100" type="text" class="form-control" id="cuil_prop" placeholder=" CUIL" wire:model.defer="dni">
			            </div>	
		        	</div>
		       ...
		       <div class="form-group row">
		        	...
		        	<div class="col-12 col-md-6 pt-3 pt-md-0">
			            ...
			            <select class="mayus custom-select form-estilo prueba w-100" id="provincia_prop" name="provincia" wire:model.defer="province_id">
		        	...
		        	<div class="col-12 col-md-6 pt-md-0">
		        		@error('city_id') <span class="pl-2 text-danger">{{ $message }}</span> @enderror
			          	 <div class="ui-widget" wire:ignore>
							<input placeholder="ESCRIBA EL NOMBRE DE LA LOCALIDAD" value="{{$city_old}}" id="select-city-by-provincia-prop" class="mayus form-estilo prueba w-100" autocomplete="off">
							<input type="hidden" name="city_id" wire:model.defer="city_id" id="select-city-by-provincia-id-prop">
						</div>
...
<script>
	...
	$(document).ready(function()
	{
		...
		$('#provincia_prop').on('change', function()
		{
			...
			$( '#select-city-by-provincia-prop' ).val( '' );
			$( '#select-city-by-provincia-id-prop' ).val( '' );
			$.ajax(
			{
				url: url,
				type: 'get',
				...
				success: function(cities) 
				{
				    ...
				    $('#select-city-by-provincia-prop').autocomplete({
					    minLength: 0,
					    source: ciudades,
					    appendTo: ".modal-propietario",
					    focus: function( event, ui ) {
					        $( '#select-city-by-provincia-prop' ).val( ui.item.label );
					        return false;
					    },
					    select: function( event, ui ) {
					        $( '#select-city-by-provincia-prop' ).val( ui.item.label );
					        $( '#select-city-by-provincia-id-prop' ).val( ui.item.value );
