...
@endphp
<div>
<div class="mt-5 modal modal-rechazar fade bd-example-modal-sm" id="uniqueid{{$references}}" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        	   			...
        	   			<div class="col-12 text-center">
        	   				...
        	   				<div class="form-group row ">
					        	<div class="text-center col-12">
                                    ...
                                    <p class="panel-admin-table-title" id="file-suscripcion-moto"></p>
					        		<input type="file" id="file-three" name="file" />						        	
