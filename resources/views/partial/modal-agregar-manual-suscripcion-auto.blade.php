...
@endphp
<div>
<div class="mt-5 modal modal-rechazar fade bd-example-modal-sm" name="modal" id="uniqueid{{$references}}" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
