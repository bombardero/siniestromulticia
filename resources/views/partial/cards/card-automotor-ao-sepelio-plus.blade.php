            ...
            <div class="col-12 col-lg-9">
                <ul class="automotor">
                    <li class="card-icon-ao-sepelio-plus text-list-automotor">RESP/CIVIL OBLIGATORIA por lesiones y/o
                        ...
                        suma máxima de $3.900.000 (pesos dos millones trescientos mil); Daños Materiales a terceros con
                        límite hasta $200.000 (pesos doscientos mil); cubriendo Gastos Sanatoriales hasta $170.000 (pesos
                        ochenta mil), por persona, y Gastos por Sepelio hasta la suma de $100.000 (pesos setenta mil).
                    </li>
                </ul>
