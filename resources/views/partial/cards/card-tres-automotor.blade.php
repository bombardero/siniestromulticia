	...
	<div class="card-body">
			<div class="row">
				...
				<div class="col-12 col-md-6 text-md-right">
					<img src="{{url('/images/automotor/finisterre.com_seguro-automotor_cobertura-mas-vendida.svg')}}" class=" img-fluid">
		...
		<div class="row">
			<div class="col-12 col-lg-9">
				...
				<ul class="automotor">
					...
					<li class="card-icon-three text-list-automotor">Límite de Responsabilidad Civil:  $17.500.000</li>
