	...
	<div class="card-body">
		...
		<div class="row">
			<div class="col-12 col-lg-9">
				<p class="card-automotor-text">Protege al titular o conductor autorizado por los daños que pudiera producir el vehículo a personas transportas y no trasportadas y/o cosas.</p>
				<ul class="automotor">
					<li class="card-icon-two text-list-automotor">Responsabilidad Civil</li>
					<li class="card-icon-two text-list-automotor">Daños a personas transportados y no transportados.</li>
					<li class="card-icon-two text-list-automotor">Límite de Responsabilidad Civil:  $17.500.000</li>
				</ul>
