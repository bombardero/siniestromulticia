    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-md-6 text-md-right">
                <img src="{{url('/images/automotor/finisterre.com_seguro-automotor_cobertura-recomendada.svg')}}"
                     class=" img-fluid">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-9">
                ...
                <ul class="automotor">
                    ...
                    <li class="card-icon-two text-list-automotor">Cobertura de Sepelio. Tope de reintegro hasta $100.000</li>
