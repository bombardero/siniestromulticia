            ...
            <div class="col-12 col-md-6 text-center  pb-3 pb-md-0 pt-md-5 text-md-right">
              <a href="tel:08103620700"><img src="{{url('/images/llamargrua.svg')}}" class=" img-fluid"></a>
    			...
    			<div class="row mx-auto">
    				<div class="col-12">
    					@include('partial.cards.card-uno-automotor')
    				</div>
    			...
    			<div class="row">
    				<div class="col-12">
                    @if($anexoPoliza)
    					<p class="pt-5 text-center text-uppercase anexos-automotor"><a  class="anexos-automotor" target="_blank" href="{{$anexoPoliza->url}}
                        ">ver anexos pólizas del automotor</a></p>
                    @endif
                    @if($manualSuscripcionAuto)
                        <p class="pt-1 text-center text-uppercase anexos-automotor"><a  class="anexos-automotor" target="_blank" href="{{$manualSuscripcionAuto->url}}
                        ">VER MANUAL DE SUSCRIPCIóN</a></p>
                    @endif
    				</div>
    			</div>
    			...
    			<div class="pt-5 row ">
    				<div class="col-12 text-center">
    					<img src="{{url('/images/automotor/Finisterre.com_seguro-automotores_image.svg')}}" class=" img-fluid">    				
    				</div>
    			</div>
    		</div>
        ...
        <div class="container" >     
            <div class="row">
                  <div class="col-12 col-md-9 order-md-1">
                      ...
                      <p class="pt-3 text-md-left text-center circula-tranquilo-text ">Circulá tranquilo con tu póliza en formato digital en tu celular</p>
                      <p class="text-center text-md-left pt-4 seguro-terceros">
                          SEGURO DE RESPONSABILIDAD CIVIL LIMITADA
                      </p>
                      <p class="text-md-left subencabezado-texto-imagenes">• COBERTURA “A” RESPONSABILIDAD CIVIL por lesiones y/o muerte de terceros transportados y no transportados, y por daños materiales a cosas de terceros no transportados, hasta la suma máxima de $17.500.000 (incluye seguro de Responsabilidad Civil Obligatorio)</p>                
                  </div>
                 ...
                 <div class="col-12 col-md-6 text-center order-md-3 ">
                      ...
                      <img src="{{url('/images/celu-segumotos-nueva.png')}}" class="text-center img-fluid d-block d-md-none w-100">
                      <p class="pt-5 text-md-left">
                        <span class="por-mes-text">desde</span> <span class="precio-por-mes"> $250*</span> <span class="por-mes-text">x mes</span>
                      </p>

                      <p class="texto-zona text-md-left">
                         <b>ZONA 1:  $300 x mes.</b> C.A.B.A - A.M.B.A.
                        <br>
                         <b>ZONA 2: $280 x mes.</b> Córdoba y Gran Córdoba
                        <br>
                         <b>ZONA 3: $250 x mes.</b> Resto de Buenos Aires, resto de Córdoba, Catamarca, Corrientes, Chaco, Chubut, Entre Ríos, Formosa, Jujuy, La Pampa, La Rioja, Mendoza, Misiones, Neuquén, Río Negro, Salta, San Juan, San Luis, Santa Cruz, Santa Fe, Tierra del Fuego, Tucumán.
                      </p>
  ...
  {{--                     <div class="text-md-left pt-5 text-center d-none d-md-block">
                   ...
                   <div class="mb-5 card-seguro-moto">
                   	<div class="card-body text-center">
                   		<img src="{{url('/images/automotor/Finisterre.com_seguro-motos_servicio-de-grua.svg')}}" class="text-center img-fluid">
                   		<br>
                  ...
                  <div class="col-12">
                    ...
                    <p class="pt-1 text-center text-uppercase anexos-automotor"><a  class="anexos-automotor" target="_blank" href="{{$manualSuscripcionMoto->url}}
                      ">VER MANUAL DE SUSCRIPCIóN </a>
                    </p>
                    @endif
                  </div>
                </div>        
                <div class="col-md-6 order-md-4 align-self-end">
                     <img src="{{url('/images/celu-segumotos-nueva.png')}}" class="d-none d-md-block text-center img-fluid  w-100">
                </div>
                ...
                <div class="col-12 text-center order-md-2">
                    <div class="d-flex justify-content-center">
                        <a id="hablemos" class="mr-md-5" href="{{route('garantias')}}#requisitos">
                            <button type="button" class="mt-5 mb-5 imagen-boton-chateamos btn btn-success">REQUISITOS PARA CONTRATARLO</button>
                        </a>
                    </div>
                </div>
                <div class="pb-4 pt-md-5 pb-md-5 col-12 col-md-6 order-md-3">
                    <div class="card card-formulario mx-auto">
                        <div class="card-body">
                            ...
                            <h4 class="card-title text-center text-md-left cotiza-segundo">Cotizás y pre-aprobás en segundos.</h4>
                            <h4 class="card-subtitle mb-2  text-center text-md-left cotiza-subtitulo">Mejor que una garantía propietaria</h4>
                           <x-form-cotizacion :cotizacionRuta="$cotizacionRuta" :textFormCotizacion="$textFormCotizacion" :comunicateNosotros="''"/>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 text-center text-md-left">
                    ...
                    <div class="pt-md-5">
                        <a id="hablemos"  class="" href="{{route('garantias')}}#garantias-obras-servicios">
                            <button type="button" class="imagen-boton-chateamos btn btn-success">Garantías de Obra y/o Servicios</button>
                        </a>
                        <a id="hablemos"  class="" href="{{route('garantias')}}#garantias-aduaneras">
                            <button type="button" class="imagen-boton-chateamos btn btn-success">Garantías Aduaneras</button>
                        </a>
                        <a id="hablemos"  class="" href="{{route('garantias')}}#garantias-judiciales">
                            <button type="button" class="imagen-boton-chateamos btn btn-success">Garantías Judiciales</button>
                        </a>
                        <a id="hablemos"  class="" href="{{route('garantias')}}#garantias-actividades">
                            <button type="button" class="imagen-boton-chateamos btn btn-success">Garantías de Actividad y/o Profesión</button>
                        </a>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="sepelio-subtitulo">
                        ...
                        Brindamos respuesta económica y  administrativa ante el fallecimiento de un integrante del grupo familiar primario por un capital determinado.
                    </p>
                    <p class="sepelio-subtitulo">
                    ...
                    <table class="mx-auto table-sepelio table-striped-sepelio table-hover-sepelio">
                      ...
                      <tbody class="tbody-purple">
                        <tr>
                          ...
                          <td class="texto-columnas-tabla">$ 220/mes </td>
                          <td class="texto-columnas-tabla">$ 470/mes</td>
                        </tr>
                        <tr>
                          <td class="texto-columnas-tabla">$ 90.000</td>
                          <td class="texto-columnas-tabla">$ 288/mes</td>
                          <td class="texto-columnas-tabla">$ 390/mes</td>
                        </tr>

                      </tbody>
                    </table>
                    <a id="boton-sepelio" class="" href="{{route('sepelio.index')}}">
                        <button type="button" class="mt-5 boton-solicitar-asesoramiento btn btn-secondary">Formulario de Solicitud</button>
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-12 pt-md-5 pt-2 text-center">
                    ...
                    <div class="d-none d-md-block  col-12 text-center position-relative">
                      <img src="{{url('/images/finisterre-seguros_home_Unite-a-nuestro-equipo.png')}}" class="img-fluid ">
                      <a id="hablemos"  class="d-none d-md-block position-absolute" href="{{route('productor.alta',['state' => 'productor'])}}">
                        <button type="button" class="imagen-boton-chateamos btn btn-produci-con-nosotros">Producí con nosotros</button>
                      </a>
                    </div>
