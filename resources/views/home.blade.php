                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        ">VER MANUAL DE SUSCRIPCIÓN (Actualizado
                                    ...
                                    ). Los cambios entran en vigencia a partir del 01/03/2024</a></p>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        @if($manualSuscripcionMoto)
                            ...
                            <p class="pt-1 text-center text-uppercase anexos-automotor"><a  class="anexos-automotor" target="_blank" href="{{$manualSuscripcionMoto->url}}">
                                VER MANUAL DE SUSCRIPCIóN (Actualizado el {{\Carbon\Carbon::parse($manualSuscripcionMoto->updated_at)->format('d/m/Y')}}). Los cambios entran en vigencia a partir del 01/03/2024</a>
                            </p>
                        @endif
                    </div>
                </div>
