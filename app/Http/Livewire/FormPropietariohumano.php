...
class FormPropietariohumano extends Component
{
    ...
    public function mount(Solicitud $solicitud, $updateMode) {
        ...
        {
             if($updateMode && $solicitud->propietario->type == 1)
            ...
            {
            $this->blockMode=true;
            $this->tipoPersonaAlerta =  "Este propietario es una persona juridica, para editarlo cambia a pestaña 'Persona Juridica' ";
            }
    ...
    public function store()
    {
        ...
        $propietario =  Propietario::create(array_merge($this->validate(),['type' => true]));
    ...
    public function update()
    {
      ...
      $propietario->update(array_merge($this->validate(),['type' => true]));
    ...
    {
        return view('livewire.form-propietariohumano',['provinces' => $this->provinces, 'cities' => $this->cities]);
    }
