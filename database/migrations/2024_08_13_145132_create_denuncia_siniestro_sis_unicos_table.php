...
class CreateDenunciaSiniestroSisUnicosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('denuncia_siniestro_sis_unicos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('denuncia_siniestro_sis_unicos');
    }
}
