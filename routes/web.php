...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['check.siniestro'], 'prefix' => 'siniestros', 'as' => 'siniestros.'], function () {
        ...
        Route::group(['prefix' => 'reclamos', 'as' => 'reclamos.'], function () {
            ...
            Route::post('{reclamo}/vincular', [SiniestroReclamoTerceroController::class,'vincularStore'])->name('vincular.store');
...
Route::group(['middleware' => ['auth','check.siniestro'], 'prefix' => 'ajax/admin/siniestros', 'as' => 'ajax.admin.siniestros.'], function () {
    ...
    Route::group(['prefix' => 'reclamos', 'as' => 'reclamos.'], function () {
        Route::get('{reclamo}/show', [ReclamoTerceroAjaxController::class,'show'])->name('show');
        ...
        Route::get('{reclamo}/vincular', [ReclamoTerceroAjaxController::class,'vincularSearch'])->name('vincular.search');
    });
});
